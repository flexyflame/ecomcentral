...
if (!class_exists('Spreadsheet_Excel_Writer_BIFFwriter')) {
    ...
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Spreadsheet/Excel/Writer/Format.php';
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Spreadsheet/Excel/Writer/BIFFwriter.php';
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Spreadsheet/Excel/Writer/Worksheet.php';
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Spreadsheet/Excel/Writer/Parser.php';
}

if (!class_exists('OLE_PPS_Root')) {
    require_once $_SERVER['DOCUMENT_ROOT'] . '/OLE/PPS/Root.php';
}

if (!class_exists('OLE_PPS_File')) {
    require_once $_SERVER['DOCUMENT_ROOT'] . '/OLE/PPS/File.php';
}

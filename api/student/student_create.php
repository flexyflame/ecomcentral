<?php
    ...
    if ($id_student != 0) {
		if ($id_student != "") {
		    ...
		    $query .= "'" . $text_house . "', '" . $text_parent .  "', '" . $text_homelanguage .  "', '" . $select_status .   "', CURDATE(), '" . $id_users .  "', '" . $select_startyear .  "', '" . $select_yeargroup .  "', '" . $select_religion . "');";
	...
	if ($api_auth != false) {
		...
		$http_result_data .= '<student_list>' . "\r\n";	
			$http_result_data .= '<student>' . "\r\n";
				...
				$http_result_data .= '<info>Data inserted!</info>' . "\r\n";
			$http_result_data .= '</student>' . "\r\n";
		$http_result_data .= '</student_list>' . "\r\n";
